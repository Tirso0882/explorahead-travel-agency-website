...
const destinations = [
  {
    ...
    description: "Iconic white-washed buildings cascading down volcanic cliffs, spectacular sunsets, and crystal-clear waters.",
  ...
  },
  {
    ...
    description: "Lush rice terraces, ancient temples, vibrant culture, and world-class surfing await in this tropical paradise.",
  ...
  },
  {
    ...
    description: "Overwater bungalows, pristine beaches, and underwater wonderlands in the ultimate tropical escape.",
  ...
  },
  {
    ...
    description: "Ancient temples, traditional tea houses, stunning gardens, and the essence of Japanese culture.",
  ...
  },
  {
    ...
    description: "Dramatic cliffs, colorful villages, and la dolce vita along Italy's most stunning coastline.",
  ...
  },
  {
    ...
    duration: "5 days",
    style: ["Cultural", "Adventure"],
    description: "Vibrant souks, stunning riads, and the magic of the medina await in this enchanting city.",
  ...
  },
  {
    ...
    region: "Americas",
    image: "https://images.unsplash.com/photo-1531761535209-180857e963b9?q=80&w=1974&auto=format&fit=crop",
    price: "$3,999",
    priceCategory: "Luxury",
    duration: "12 days",
    style: ["Adventure", "Wildlife"],
    description: "Dramatic glaciers, towering peaks, and pristine wilderness at the end of the world.",
  ...
  },
  {
    ...
    description: "Witness the great migration and encounter Africa's most iconic wildlife on an unforgettable safari.",
  ...
  },
  {
    ...
    country: "New Zealand",
    region: "Oceania",
    image: "https://images.unsplash.com/photo-1469521669194-babb45599def?q=80&w=2076&auto=format&fit=crop",
    price: "$3,299",
    priceCategory: "Luxury",
    duration: "14 days",
    style: ["Adventure", "Wildlife"],
    description: "From fjords to volcanoes, experience Middle-earth's breathtaking landscapes and adventure sports.",
...
export default function DestinationsPage() {
  ...
  const hasActiveFilters = searchQuery || selectedRegion !== "All" || selectedStyle !== "All" || selectedPrice !== "All";
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 container text-center">
          ...
          >
            From sun-kissed beaches to snow-capped mountains, discover handpicked
      ...
      {/* Filters Section */}
      <section className="sticky top-20 z-30 bg-white border-b border-gray-lighter shadow-sm">
        <div className="container py-4">
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
            ...
            <div className="flex flex-wrap gap-2 flex-1">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm text-gray font-medium">Region:</span>
                <div className="flex gap-1 flex-wrap">
                  {regions.map((region) => (
                    <button
                      key={region}
                      onClick={() => setSelectedRegion(region)}
                      className={`px-3 py-1.5 text-sm font-medium rounded-[20px] h-[30px] transition-all duration-200 ease-out ${
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray font-medium">Style:</span>
              <select
                value={selectedStyle}
                onChange={(e) => setSelectedStyle(e.target.value)}
                className="px-3 py-1.5 text-sm rounded-lg bg-sand-light text-ocean border-none focus:ring-2 focus:ring-gold"
              >
            ...
            <div className="flex items-center gap-2">
              <span className="text-sm text-gray font-medium">Budget:</span>
              <select
                value={selectedPrice}
        ...
        <div className="container">
          ...
          <div className="mb-8">
            <p className="text-gray-dark">
              Showing <span className="font-semibold text-ocean">{filteredDestinations.length}</span> destinations
            </p>
          </div>
                  ...
                  <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="relative aspect-[4/3] overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 flex gap-2">
                        {destination.style.slice(0, 2).map((style) => (
                          <span
                            key={style}
                            className="px-5 py-2.5 text-xs font-medium bg-white/90 text-ocean rounded-full"
                          >
                            {style}
                          </span>
                        ))}
                      ...
                      <div className="absolute top-4 right-4">
                        <span className="px-6 py-2.5 text-sm font-semibold bg-gold text-ocean-dark rounded-full">
                          {destination.price}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          <h3 className="text-xl font-heading text-ocean">
                            {destination.name}
                          </h3>
                      ...
                      <p className="text-gray-dark text-sm line-clamp-2 mb-4">
                        {destination.description}
                      </p>

                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray">{destination.priceCategory}</span>
                        <span className="flex items-center gap-1 text-gold font-medium group-hover:text-ocean transition-colors">
                          View Details
          ...
          {filteredDestinations.length === 0 && (
            ...
            >
              <p className="text-xl text-gray-dark mb-4">No destinations found</p>
      ...
      <section className="section bg-ocean">
        <div className="container text-center">
          ...
          <p className="text-white/80 mb-8 max-w-xl mx-auto">
            Our AI Travel Specialist can help you discover hidden gems and create
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {selectedDestination.highlights.map((highlight) => (
                  <span
                    key={highlight}
                    className="px-5 py-2 bg-sand-light text-ocean text-sm rounded-full"
                  >
                    {highlight}
                  </span>
                ))}
