...
import { Shield, Mail, Phone, Lock, Database, UserCheck, Eye, FileText } from "lucide-react";
...
export default function PrivacyPolicyPage() {
  ...
  const content = isEnglish ? {
    hero: {
      ...
      subtitle: "We respect your privacy and protect your personal data in accordance with GDPR"
    },
      ...
      <section className="section">
        <div className="container max-w-4xl">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="mt-16 bg-gradient-to-br from-ocean to-ocean-dark rounded-2xl p-8 text-center text-white"
          >
